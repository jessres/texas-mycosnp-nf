...
for resuts in combined;
do
echo "Uploading analysis results to aws s3 bucket" && sudo aws s3 cp $run_dir/$1/combined/phylogeny/fasttree/ s3://804609861260-bioinformatics-infectious-disease/Candida/ANALYSIS_RESULT/$1/fasttree --region us-gov-west-1 --recursive && sudo aws s3 cp $run_dir/$1/combined/phylogeny/rapidnj/ s3://804609861260-bioinformatics-infectious-disease/Candida/ANALYSIS_RESULT/$1/rapidnj --region us-gov-west-1 --recursive && sudo aws s3 cp $rund_dir/$1/combined/phylogeny/vcf-to-fasta/ s3://804609861260-bioinformatics-infectious-disease/Candida/ANALYSIS_RESULT/$1/vcf-to-fasta --region us-gov-west-1 --recursive && sudo aws s3 cp $run_dir/output/$1/$1"_QCREPORT.txt"/ s3://804609861260-bioinformatics-infectious-disease/Candida/ANALYSIS_RESULT/$1 --region us-gov-west-1 && echo "Analysis Complete!"
done
